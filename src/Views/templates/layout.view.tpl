...
<body>
  <header>
    ...
    <nav id="menu">
      <ul>
        ...
        <li><a href="index.php?page=NW202202_PrimerForm"><i class="fas fa-user-plus"></i>&nbsp;Primer Form de la Clase</a></li>
  ...
  <main>
  {{{page_content}}} <!--Es sumamente importante que el page_content este en 3 llaves-->
  </main>
  <footer>
